...
//@Test 메소드가 실행되기전에 제공한 조립 설명서를 바탕으로 스프링 컨테이너를 구축
...
public class SpringContainerTest {
	...
	/**
	 * Method : boardServiceCoBeantest
	 * 작성자 : PC-18
	 * 변경이력 :
	 * Method 설명 :boardServiceCo 스프링 빈 적용
	 */
	@Test
	...
	public void springBeanScopeTest() {
		...
		//스프링 빈, prototype 정의(요청될때마다 새로운 객체를만들어줌)에 따라 두 필드에 주입된 객체는 서로 다른 객체이다
